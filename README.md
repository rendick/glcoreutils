...
|rm |File utilities|Removes deletes files, directories, device nodeshttps://en.wikipedia.org/w/index.php?title=Device_nodes&action=edit&redlink=1 "Device nodes page does not exist" and symbolic links|
...
|touch |create file|[fc](https://github.com/GLCU/utils/blob/main/src/fc.go)|
...
|id |Shell utilities|Prints real or effective UIDUser_identifier "User identifier" and GIDGroup_identifier_Unix "Group identifier Unix"|
...
|whoami |Shell utilities|Prints the effective useridUserid "Userid"|
